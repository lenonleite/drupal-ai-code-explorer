...
Clone or place this repository in a Drupal site's custom-module directory:

```text
web/modules/custom/drupal_developer_assistant
```

For a DDEV project, install the Composer dependencies and enable the module:
...
The GitHub workflow creates a temporary Drupal site and installs this repository
as a module. Drupal core and the development site are not stored in this
repository.
